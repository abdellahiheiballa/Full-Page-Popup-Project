  ...
  return (
    ...
    >
      ...
      <MotionBox
        ...
        transition={{
          delay: 1.1, // 1-second delay before the animation starts
          duration: 0.7, // Length of the animation
          ease: "easeInOut",
        }}
      >
        {/* Responsive Image using Next.js Image */}
        <Image
          src="/images/Glare.gif" // Ensure the correct path to your GIF
          alt="Charging Effect"
          width={900} // Initial size, can be adjusted
          height={500} // Adjust height
          style={{
            filter: ' drop-shadow(0 0 12px rgba(219,120,15,255))',  // Optional: Adjust brightness and shadow
          }}
        />
      </MotionBox>
    </Box>
